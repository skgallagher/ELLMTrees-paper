...
\begin{table}[t]
\caption{Closest lineage-estimation methods. \emph{Controlled trees}: families the authors fine-tuned.}
\label{tab:related}
\begin{center}
\footnotesize
...
\toprule
Method & Access & \shortstack{Latent\\ancestors} & \shortstack{Controlled\\trees} & \shortstack{Documented\\lineage} & \shortstack{Weight--\\behavior} & \shortstack{Cross-\\arch.} \\
\midrule
MoTHer \citep{horwitz2025mother}
  & weights  & \ding{55}  & ViT        & \checkmark & \ding{55}  & \ding{55} \\
Neural Phylogeny \citep{yu2025neural}
  & weights  & \ding{55}  & vision     & \checkmark & \ding{55}  & \ding{55} \\
PhyloLM \citep{yax2025phylolm}
  & behavior & \checkmark & \ding{55}  & \checkmark & \ding{55}  & \checkmark \\
