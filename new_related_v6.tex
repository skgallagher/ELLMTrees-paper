...
\textbf{Our Approach:} We compare these weight and behavior based approaches, determine where phylogenetic signal can be detected, and evaluate the estimated phylogenies against known true trees. Our findings are consistent with prior work showing that inherited behavioral signals can be preserved under sufficient training signal \citep{cloud2025subliminal}, as well as phylogenetic results showing that the underlying tree can be correctly estimated when certain conditions on the estimated distances are satisfied \citep{atteson1999performance}.  As shown in Table~\ref{tab:related}, our work differs from other close methods due to our weight-based estimation, use of latent ancestors which allows for missing models, our LLM-based controlled experiments, link between weight and behavior, and use of a tree likeness score to express empirical confidence in our estimated phylogeny.
