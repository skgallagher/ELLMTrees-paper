...
\begin{scope}
  ...
  \begin{scope}[shift={(12.10,1.78)}]
    ...
    \node[lab,text=flow,rotate=90,anchor=south] at (-0.12,0.98) {branches recovered};
  ...
  \node[scap,anchor=north] at (13.675,0.66) {recovery odds $\times$5.9 per\\+0.1 in tree-likeness $A$};
\end{scope}
